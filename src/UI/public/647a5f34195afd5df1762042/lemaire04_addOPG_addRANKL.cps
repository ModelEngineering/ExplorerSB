...
<!-- generated with COPASI 4.6.32 (Debug) (http://www.copasi.org) at 2010-11-19 12:49:58 UTC -->
<?oxygen RNGSchema="http://www.copasi.org/static/schema/CopasiML.rng" type="xml"?>
<COPASI xmlns="http://www.copasi.org/static/schema" versionMajor="1" versionMinor="0" versionDevel="32">
  <Model key="Model_1" name="Lemaire2004_BoneRemodeling_addRANKLandOPG" simulationType="time" timeUnit="s" volumeUnit="l" areaUnit="m²" lengthUnit="m" quantityUnit="mol" type="deterministic">
    <MiriamAnnotation>
<rdf:RDF
  ...
  <rdf:Description rdf:about="#Model_1">
    <dcterms:created>
      <rdf:Description>
        <dcterms:W3CDTF>2010-11-19T12:43:38Z</dcterms:W3CDTF>
      </rdf:Description>
    </dcterms:created>
  </rdf:Description>
...
We propose a mathematical model explaining the interactions between osteoblasts and osteoclasts, two cell types specialized in the maintenance of the bone integrity. Bone is a dynamic, living tissue whose structure and shape continuously evolves during life. It has the ability to change architecture by removal of old bone and replacement with newly formed bone in a localized process called remodeling. The model described here is based on the idea that the relative proportions of immature and mature osteoblasts control the degree of osteoclastic activity. In addition, osteoclasts control osteoblasts differentially depending on their stage of differentiation. Despite the tremendous complexity of the bone regulatory system and its fragmentary understanding, we obtain surprisingly good correlations between the model simulations and the experimental observations extracted from the literature. The model results corroborate all behaviors of the bone remodeling system that we have simulated, including the tight coupling between osteoblasts and osteoclasts, the catabolic effect induced by continuous administration of PTH, the catabolic action of RANKL, as well as its reversal by soluble antagonist OPG. The model is also able to simulate metabolic bone diseases such as estrogen deficiency, vitamin D deficiency, senescence and glucocorticoid excess. Conversely, possible routes for therapeutic interventions are tested and evaluated. Our model confirms that anti-resorptive therapies are unable to partially restore bone loss, whereas bone formation therapies yield better results. The model enables us to determine and evaluate potential therapies based on their efficacy. In particular, the model predicts that combinations of anti-resorptive and anabolic therapies provide significant benefits compared with monotherapy, especially for certain type of skeletal disease. Finally, the model clearly indicates that increasing the size of the pool of preosteoblasts is an essential ingredient for the therapeutic manipulation of bone formation. This model was conceived as the first step in a bone turnover modeling platform. These initial modeling results are extremely encouraging and lead us to proceed with additional explorations into bone turnover and skeletal remodeling.
  ...
  <p> This model is an extension of the core model in which, RANKLs (I_L) are being added constantly from day 20 at 10000pM/day and Osteoprotegerin-OPGs (I_O) being added constantly 60 days later (i.e at day 80) at 90000pM/day. The model reproduces (Figure 9 of the curation figure), the last plot of Figure 2C of the reference publication.
    ...
    <ListOfMetabolites>
      <Metabolite key="Metabolite_0" name="Responding_Osteoblasts" simulationType="ode" compartment="Compartment_0">
        <Expression>
          &lt;CN=Root,Model=Lemaire2004_BoneRemodeling_addRANKLandOPG,Vector=Values[D_R],Reference=Value&gt;*&lt;CN=Root,Model=Lemaire2004_BoneRemodeling_addRANKLandOPG,Vector=Values[Phi_C],Reference=Value&gt;-&lt;CN=Root,Model=Lemaire2004_BoneRemodeling_addRANKLandOPG,Vector=Values[D_B],Reference=Value&gt;*&lt;CN=Root,Model=Lemaire2004_BoneRemodeling_addRANKLandOPG,Vector=Compartments[Compartment],Vector=Metabolites[Responding_Osteoblasts],Reference=Concentration&gt;/&lt;CN=Root,Model=Lemaire2004_BoneRemodeling_addRANKLandOPG,Vector=Values[Phi_C],Reference=Value&gt;
        </Expression>
      </Metabolite>
      <Metabolite key="Metabolite_1" name="Active_Osteoblasts" simulationType="ode" compartment="Compartment_0">
        <Expression>
          &lt;CN=Root,Model=Lemaire2004_BoneRemodeling_addRANKLandOPG,Vector=Values[D_B],Reference=Value&gt;*&lt;CN=Root,Model=Lemaire2004_BoneRemodeling_addRANKLandOPG,Vector=Compartments[Compartment],Vector=Metabolites[Responding_Osteoblasts],Reference=Concentration&gt;/&lt;CN=Root,Model=Lemaire2004_BoneRemodeling_addRANKLandOPG,Vector=Values[Phi_C],Reference=Value&gt;-&lt;CN=Root,Model=Lemaire2004_BoneRemodeling_addRANKLandOPG,Vector=Values[k_B],Reference=Value&gt;*&lt;CN=Root,Model=Lemaire2004_BoneRemodeling_addRANKLandOPG,Vector=Compartments[Compartment],Vector=Metabolites[Active_Osteoblasts],Reference=Concentration&gt;
        </Expression>
      </Metabolite>
      <Metabolite key="Metabolite_2" name="Active_Osteoclasts" simulationType="ode" compartment="Compartment_0">
        <Expression>
          &lt;CN=Root,Model=Lemaire2004_BoneRemodeling_addRANKLandOPG,Vector=Values[D_C],Reference=Value&gt;*&lt;CN=Root,Model=Lemaire2004_BoneRemodeling_addRANKLandOPG,Vector=Values[Phi_L],Reference=Value&gt;-&lt;CN=Root,Model=Lemaire2004_BoneRemodeling_addRANKLandOPG,Vector=Values[D_A],Reference=Value&gt;*&lt;CN=Root,Model=Lemaire2004_BoneRemodeling_addRANKLandOPG,Vector=Values[Phi_C],Reference=Value&gt;*&lt;CN=Root,Model=Lemaire2004_BoneRemodeling_addRANKLandOPG,Vector=Compartments[Compartment],Vector=Metabolites[Active_Osteoclasts],Reference=Concentration&gt;
        </Expression>
      </Metabolite>
    </ListOfMetabolites>
    <ListOfModelValues>
      ...
      <ModelValue key="ModelValue_6" name="I_L" simulationType="assignment">
        <Expression>
          if(&lt;CN=Root,Model=Lemaire2004_BoneRemodeling_addRANKLandOPG,Reference=Time&gt; ge 20,10000,0)
        </Expression>
      </ModelValue>
      <ModelValue key="ModelValue_7" name="I_O" simulationType="assignment">
        <Expression>
          if(&lt;CN=Root,Model=Lemaire2004_BoneRemodeling_addRANKLandOPG,Reference=Time&gt; ge 80,90000,0)
        </Expression>
      </ModelValue>
      ...
      <ModelValue key="ModelValue_23" name="Phi_C" simulationType="assignment">
        <Expression>
          (&lt;CN=Root,Model=Lemaire2004_BoneRemodeling_addRANKLandOPG,Vector=Compartments[Compartment],Vector=Metabolites[Active_Osteoclasts],Reference=Concentration&gt;+&lt;CN=Root,Model=Lemaire2004_BoneRemodeling_addRANKLandOPG,Vector=Values[f0],Reference=Value&gt;*&lt;CN=Root,Model=Lemaire2004_BoneRemodeling_addRANKLandOPG,Vector=Values[C_s],Reference=Value&gt;)/(&lt;CN=Root,Model=Lemaire2004_BoneRemodeling_addRANKLandOPG,Vector=Compartments[Compartment],Vector=Metabolites[Active_Osteoclasts],Reference=Concentration&gt;+&lt;CN=Root,Model=Lemaire2004_BoneRemodeling_addRANKLandOPG,Vector=Values[C_s],Reference=Value&gt;)
        </Expression>
      </ModelValue>
      <ModelValue key="ModelValue_24" name="D_B" simulationType="assignment">
        <Expression>
          &lt;CN=Root,Model=Lemaire2004_BoneRemodeling_addRANKLandOPG,Vector=Values[f0],Reference=Value&gt;*&lt;CN=Root,Model=Lemaire2004_BoneRemodeling_addRANKLandOPG,Vector=Values[d_B],Reference=Value&gt;
        </Expression>
      </ModelValue>
      <ModelValue key="ModelValue_25" name="Phi_L" simulationType="assignment">
        <Expression>
          &lt;CN=Root,Model=Lemaire2004_BoneRemodeling_addRANKLandOPG,Vector=Values[k3],Reference=Value&gt;/&lt;CN=Root,Model=Lemaire2004_BoneRemodeling_addRANKLandOPG,Vector=Values[k4],Reference=Value&gt;*&lt;CN=Root,Model=Lemaire2004_BoneRemodeling_addRANKLandOPG,Vector=Values[K_L_P],Reference=Value&gt;*&lt;CN=Root,Model=Lemaire2004_BoneRemodeling_addRANKLandOPG,Vector=Values[Phi_P],Reference=Value&gt;*&lt;CN=Root,Model=Lemaire2004_BoneRemodeling_addRANKLandOPG,Vector=Compartments[Compartment],Vector=Metabolites[Active_Osteoblasts],Reference=Concentration&gt;/(1+&lt;CN=Root,Model=Lemaire2004_BoneRemodeling_addRANKLandOPG,Vector=Values[k3],Reference=Value&gt;*&lt;CN=Root,Model=Lemaire2004_BoneRemodeling_addRANKLandOPG,Vector=Values[K],Reference=Value&gt;/&lt;CN=Root,Model=Lemaire2004_BoneRemodeling_addRANKLandOPG,Vector=Values[k4],Reference=Value&gt;+&lt;CN=Root,Model=Lemaire2004_BoneRemodeling_addRANKLandOPG,Vector=Values[k1],Reference=Value&gt;/(&lt;CN=Root,Model=Lemaire2004_BoneRemodeling_addRANKLandOPG,Vector=Values[k2],Reference=Value&gt;*&lt;CN=Root,Model=Lemaire2004_BoneRemodeling_addRANKLandOPG,Vector=Values[kO],Reference=Value&gt;)*(&lt;CN=Root,Model=Lemaire2004_BoneRemodeling_addRANKLandOPG,Vector=Values[I_O],Reference=Value&gt;+&lt;CN=Root,Model=Lemaire2004_BoneRemodeling_addRANKLandOPG,Vector=Values[K_O_P],Reference=Value&gt;*&lt;CN=Root,Model=Lemaire2004_BoneRemodeling_addRANKLandOPG,Vector=Compartments[Compartment],Vector=Metabolites[Responding_Osteoblasts],Reference=Concentration&gt;/&lt;CN=Root,Model=Lemaire2004_BoneRemodeling_addRANKLandOPG,Vector=Values[Phi_P],Reference=Value&gt;))*(1+&lt;CN=Root,Model=Lemaire2004_BoneRemodeling_addRANKLandOPG,Vector=Values[I_L],Reference=Value&gt;/&lt;CN=Root,Model=Lemaire2004_BoneRemodeling_addRANKLandOPG,Vector=Values[r_L],Reference=Value&gt;)
        </Expression>
      </ModelValue>
      <ModelValue key="ModelValue_26" name="Phi_P" simulationType="assignment">
        <Expression>
          (&lt;CN=Root,Model=Lemaire2004_BoneRemodeling_addRANKLandOPG,Vector=Values[Pbar],Reference=Value&gt;+&lt;CN=Root,Model=Lemaire2004_BoneRemodeling_addRANKLandOPG,Vector=Values[P_O],Reference=Value&gt;)/(&lt;CN=Root,Model=Lemaire2004_BoneRemodeling_addRANKLandOPG,Vector=Values[Pbar],Reference=Value&gt;+&lt;CN=Root,Model=Lemaire2004_BoneRemodeling_addRANKLandOPG,Vector=Values[P_S],Reference=Value&gt;)
        </Expression>
      </ModelValue>
      <ModelValue key="ModelValue_27" name="Pbar" simulationType="assignment">
        <Expression>
          &lt;CN=Root,Model=Lemaire2004_BoneRemodeling_addRANKLandOPG,Vector=Values[I_P],Reference=Value&gt;/&lt;CN=Root,Model=Lemaire2004_BoneRemodeling_addRANKLandOPG,Vector=Values[k_P],Reference=Value&gt;
        </Expression>
      </ModelValue>
      <ModelValue key="ModelValue_28" name="P_O" simulationType="assignment">
        <Expression>
          &lt;CN=Root,Model=Lemaire2004_BoneRemodeling_addRANKLandOPG,Vector=Values[S_P],Reference=Value&gt;/&lt;CN=Root,Model=Lemaire2004_BoneRemodeling_addRANKLandOPG,Vector=Values[k_P],Reference=Value&gt;
        </Expression>
      </ModelValue>
      <ModelValue key="ModelValue_29" name="P_S" simulationType="assignment">
        <Expression>
          &lt;CN=Root,Model=Lemaire2004_BoneRemodeling_addRANKLandOPG,Vector=Values[k6],Reference=Value&gt;/&lt;CN=Root,Model=Lemaire2004_BoneRemodeling_addRANKLandOPG,Vector=Values[k5],Reference=Value&gt;
        </Expression>
      </ModelValue>
    </ListOfModelValues>
    <StateTemplate>
    ...
    <InitialState type="initialState">
      0 4.657524236100004e+20 4.385323440300004e+20 5.49640854705e+20 0 0 0.1966445109679165 0.035 0.05982275279878374 0.01937984496124031 0 2.906976744186046 150 0.005 0.7 0.7 0.0021 0.0007 0.05 0 10 0.01 10 0.00058 0.017 0.02 3 0.189 3000000 0.35 200000 86 1000 250 1 
    </InitialState>
  </Model>
  <ListOfTasks>
    ...
    <Task key="Task_13" name="Time-Course" type="timeCourse" scheduled="false" updateModel="false">
      <Report reference="Report_16" target="fig9.dat" append="0"/>
      <Problem>
        <Parameter name="StepNumber" type="unsignedInteger" value="100"/>
        <Parameter name="StepSize" type="float" value="1.4"/>
  ...
  <ListOfReports>
    ...
    <Report key="Report_16" name="fig9" taskType="timeCourse" separator="&#x09;" precision="6">
      <Comment>
        <body xmlns="http://www.w3.org/1999/xhtml">
      ...
      <Header>
        <Object cn="CN=Root,Model=Lemaire2004_BoneRemodeling_addRANKLandOPG,Reference=Name"/>
        <Object cn="String=\[Time\]"/>
        <Object cn="Separator=&#x09;"/>
        <Object cn="CN=Root,Model=Lemaire2004_BoneRemodeling_addRANKLandOPG,Vector=Compartments[Compartment],Vector=Metabolites[Active_Osteoblasts],Reference=Name"/>
        <Object cn="String=\[Concentration\]"/>
        <Object cn="Separator=&#x09;"/>
        <Object cn="CN=Root,Model=Lemaire2004_BoneRemodeling_addRANKLandOPG,Vector=Compartments[Compartment],Vector=Metabolites[Active_Osteoclasts],Reference=Name"/>
        <Object cn="String=\[Concentration\]"/>
        <Object cn="Separator=&#x09;"/>
        <Object cn="CN=Root,Model=Lemaire2004_BoneRemodeling_addRANKLandOPG,Vector=Compartments[Compartment],Vector=Metabolites[Responding_Osteoblasts],Reference=Name"/>
        <Object cn="String=\[Concentration\]"/>
      </Header>
      <Body>
        <Object cn="CN=Root,Model=Lemaire2004_BoneRemodeling_addRANKLandOPG,Reference=Time"/>
        <Object cn="Separator=&#x09;"/>
        <Object cn="CN=Root,Model=Lemaire2004_BoneRemodeling_addRANKLandOPG,Vector=Compartments[Compartment],Vector=Metabolites[Active_Osteoblasts],Reference=Concentration"/>
        <Object cn="Separator=&#x09;"/>
        <Object cn="CN=Root,Model=Lemaire2004_BoneRemodeling_addRANKLandOPG,Vector=Compartments[Compartment],Vector=Metabolites[Active_Osteoclasts],Reference=Concentration"/>
        <Object cn="Separator=&#x09;"/>
        <Object cn="CN=Root,Model=Lemaire2004_BoneRemodeling_addRANKLandOPG,Vector=Compartments[Compartment],Vector=Metabolites[Responding_Osteoblasts],Reference=Concentration"/>
      </Body>
    </Report>
  </ListOfReports>
  <ListOfPlots>
    <PlotSpecification name="Concentrations, Volumes, and Global Quantity Values" type="Plot2D" active="1">
      ...
      <ListOfPlotItems>
        <PlotItem name="[Responding_Osteoblasts]" type="Curve2D">
          ...
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=Lemaire2004_BoneRemodeling_addRANKLandOPG,Reference=Time"/>
            <ChannelSpec cn="CN=Root,Model=Lemaire2004_BoneRemodeling_addRANKLandOPG,Vector=Compartments[Compartment],Vector=Metabolites[Responding_Osteoblasts],Reference=Concentration"/>
          </ListOfChannels>
        </PlotItem>
        <PlotItem name="[Active_Osteoblasts]" type="Curve2D">
          ...
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=Lemaire2004_BoneRemodeling_addRANKLandOPG,Reference=Time"/>
            <ChannelSpec cn="CN=Root,Model=Lemaire2004_BoneRemodeling_addRANKLandOPG,Vector=Compartments[Compartment],Vector=Metabolites[Active_Osteoblasts],Reference=Concentration"/>
          </ListOfChannels>
        </PlotItem>
        <PlotItem name="[Active_Osteoclasts]" type="Curve2D">
          ...
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=Lemaire2004_BoneRemodeling_addRANKLandOPG,Reference=Time"/>
            <ChannelSpec cn="CN=Root,Model=Lemaire2004_BoneRemodeling_addRANKLandOPG,Vector=Compartments[Compartment],Vector=Metabolites[Active_Osteoclasts],Reference=Concentration"/>
          </ListOfChannels>
        </PlotItem>
        <PlotItem name="Values[I_L]" type="Curve2D">
          <Parameter name="Line type" type="unsignedInteger" value="0"/>
          <Parameter name="Recording Activity" type="string" value="during"/>
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=Lemaire2004_BoneRemodeling_addRANKLandOPG,Reference=Time"/>
            <ChannelSpec cn="CN=Root,Model=Lemaire2004_BoneRemodeling_addRANKLandOPG,Vector=Values[I_L],Reference=Value"/>
          </ListOfChannels>
        </PlotItem>
        <PlotItem name="Values[I_O]" type="Curve2D">
          ...
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=Lemaire2004_BoneRemodeling_addRANKLandOPG,Reference=Time"/>
            <ChannelSpec cn="CN=Root,Model=Lemaire2004_BoneRemodeling_addRANKLandOPG,Vector=Values[I_O],Reference=Value"/>
          </ListOfChannels>
        </PlotItem>
        <PlotItem name="Values[Phi_C]" type="Curve2D">
          ...
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=Lemaire2004_BoneRemodeling_addRANKLandOPG,Reference=Time"/>
            <ChannelSpec cn="CN=Root,Model=Lemaire2004_BoneRemodeling_addRANKLandOPG,Vector=Values[Phi_C],Reference=Value"/>
          </ListOfChannels>
        </PlotItem>
        <PlotItem name="Values[D_B]" type="Curve2D">
          ...
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=Lemaire2004_BoneRemodeling_addRANKLandOPG,Reference=Time"/>
            <ChannelSpec cn="CN=Root,Model=Lemaire2004_BoneRemodeling_addRANKLandOPG,Vector=Values[D_B],Reference=Value"/>
          </ListOfChannels>
        </PlotItem>
        <PlotItem name="Values[Phi_L]" type="Curve2D">
          ...
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=Lemaire2004_BoneRemodeling_addRANKLandOPG,Reference=Time"/>
            <ChannelSpec cn="CN=Root,Model=Lemaire2004_BoneRemodeling_addRANKLandOPG,Vector=Values[Phi_L],Reference=Value"/>
          </ListOfChannels>
        </PlotItem>
        <PlotItem name="Values[Phi_P]" type="Curve2D">
          ...
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=Lemaire2004_BoneRemodeling_addRANKLandOPG,Reference=Time"/>
            <ChannelSpec cn="CN=Root,Model=Lemaire2004_BoneRemodeling_addRANKLandOPG,Vector=Values[Phi_P],Reference=Value"/>
          </ListOfChannels>
        </PlotItem>
        <PlotItem name="Values[Pbar]" type="Curve2D">
          ...
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=Lemaire2004_BoneRemodeling_addRANKLandOPG,Reference=Time"/>
            <ChannelSpec cn="CN=Root,Model=Lemaire2004_BoneRemodeling_addRANKLandOPG,Vector=Values[Pbar],Reference=Value"/>
          </ListOfChannels>
        </PlotItem>
        <PlotItem name="Values[P_O]" type="Curve2D">
          ...
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=Lemaire2004_BoneRemodeling_addRANKLandOPG,Reference=Time"/>
            <ChannelSpec cn="CN=Root,Model=Lemaire2004_BoneRemodeling_addRANKLandOPG,Vector=Values[P_O],Reference=Value"/>
          </ListOfChannels>
        </PlotItem>
        <PlotItem name="Values[P_S]" type="Curve2D">
          ...
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=Lemaire2004_BoneRemodeling_addRANKLandOPG,Reference=Time"/>
            <ChannelSpec cn="CN=Root,Model=Lemaire2004_BoneRemodeling_addRANKLandOPG,Vector=Values[P_S],Reference=Value"/>
          </ListOfChannels>
        </PlotItem>
      </ListOfPlotItems>
    </PlotSpecification>
  ...
  <SBMLReference file="lemaire04_addOPG_addRANKL.xml">
