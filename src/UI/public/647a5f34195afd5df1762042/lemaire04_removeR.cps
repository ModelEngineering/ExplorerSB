...
<!-- generated with COPASI 4.6.32 (Debug) (http://www.copasi.org) at 2010-11-19 12:54:11 UTC -->
<?oxygen RNGSchema="http://www.copasi.org/static/schema/CopasiML.rng" type="xml"?>
<COPASI xmlns="http://www.copasi.org/static/schema" versionMajor="1" versionMinor="0" versionDevel="32">
  <Model key="Model_0" name="Lemaire2004_BoneRemodeling_OsteoblastOsteoclast" simulationType="time" timeUnit="s" volumeUnit="l" areaUnit="m²" lengthUnit="m" quantityUnit="mol" type="deterministic">
    <MiriamAnnotation>
<rdf:RDF
  ...
  <rdf:Description rdf:about="#Model_0">
    <dcterms:created>
      <rdf:Description>
        <dcterms:W3CDTF>2010-11-19T12:52:54Z</dcterms:W3CDTF>
      </rdf:Description>
    </dcterms:created>
  </rdf:Description>
...
This model is an extension of the core model in which the Responding Osteoblasts (R) are being removed constantly from day 20 to day 80 (i.e for 60 days) at 0.00012pM/day. The model reproduces (Figure 6 of the curation figure), the last plot of Figure 2B of the reference publication.
    ...
    <ListOfModelValues>
      ...
      <ModelValue key="ModelValue_60" name="remove_Rcells" simulationType="assignment">
        <Expression>
          if(&lt;CN=Root,Model=Lemaire2004_BoneRemodeling_OsteoblastOsteoclast,Reference=Time&gt; le 80 and &lt;CN=Root,Model=Lemaire2004_BoneRemodeling_OsteoblastOsteoclast,Reference=Time&gt; gt 20,0.00012,0)
        </Expression>
      </ModelValue>
    </ListOfModelValues>
    <StateTemplate>
  ...
  <ListOfTasks>
    ...
    <Task key="Task_8" name="Time-Course" type="timeCourse" scheduled="false" updateModel="false">
      <Report reference="Report_18" target="fig6.dat" append="0"/>
      <Problem>
  ...
  <ListOfReports>
    ...
    <Report key="Report_18" name="fig6" taskType="timeCourse" separator="&#x09;" precision="6">
      <Comment>
        <body xmlns="http://www.w3.org/1999/xhtml">
  ...
  <ListOfPlots>
    <PlotSpecification name="Concentrations, Volumes, and Global Quantity Values" type="Plot2D" active="1">
      ...
      <ListOfPlotItems>
        ...
        <PlotItem name="Values[remove_Rcells]" type="Curve2D">
          <Parameter name="Line type" type="unsignedInteger" value="0"/>
          <Parameter name="Recording Activity" type="string" value="during"/>
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=Lemaire2004_BoneRemodeling_OsteoblastOsteoclast,Reference=Time"/>
            <ChannelSpec cn="CN=Root,Model=Lemaire2004_BoneRemodeling_OsteoblastOsteoclast,Vector=Values[remove_Rcells],Reference=Value"/>
          </ListOfChannels>
        </PlotItem>
      </ListOfPlotItems>
    </PlotSpecification>
  ...
  <SBMLReference file="lemaire04_removeR.xml">
    ...
    <SBMLMap SBMLid="remove_Rcells" COPASIkey="ModelValue_60"/>
  </SBMLReference>
</COPASI>
