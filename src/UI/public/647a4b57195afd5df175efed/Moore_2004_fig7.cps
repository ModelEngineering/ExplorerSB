...
<!-- generated with COPASI 4.24 (Build 197) (http://www.copasi.org) at 2019-02-20 11:40:27 UTC -->
  ...
  <rdf:Description rdf:about="#Reaction_0">
    ...
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5071" name="v" value="0.29"/>
        </ListOfConstants>
  ...
  <rdf:Description rdf:about="#Reaction_1">
    ...
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5073" name="Dn" value="0.35"/>
          <Constant key="Parameter_5074" name="Kn" value="0.066"/>
          <Constant key="Parameter_5068" name="n" value="140"/>
        </ListOfConstants>
  ...
  <rdf:Description rdf:about="#Reaction_2">
    ...
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5070" name="An" value="0.39"/>
          <Constant key="Parameter_5069" name="Kn" value="0.066"/>
          <Constant key="Parameter_5072" name="n" value="140"/>
          <Constant key="Parameter_5075" name="Ae" value="0.65"/>
        </ListOfConstants>
  ...
  <rdf:Description rdf:about="#Reaction_3">
    ...
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5066" name="De" value="0.4"/>
          <Constant key="Parameter_5064" name="gammaE" value="0.079"/>
        </ListOfConstants>
  ...
  <rdf:Description rdf:about="#Reaction_4">
    ...
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5063" name="Rc" value="0.011"/>
          <Constant key="Parameter_5067" name="Cmax" value="160000"/>
        </ListOfConstants>
  ...
  <rdf:Description rdf:about="#Reaction_5">
    ...
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5065" name="Dc" value="0.012"/>
          <Constant key="Parameter_5040" name="gammaC" value="0.058"/>
        </ListOfConstants>
    ...
    <ListOfModelParameterSets activeSet="ModelParameterSet_0">
      <ModelParameterSet key="ModelParameterSet_0" name="Initial State">
        ...
        <ModelParameterGroup cn="String=Initial Global Quantities" type="Group">
          <ModelParameter cn="CN=Root,Model=Moore_2004,Vector=Values[Sn]" value="0.28999999999999998" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Moore_2004,Vector=Values[n]" value="140" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Moore_2004,Vector=Values[Kn]" value="0.066000000000000003" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Moore_2004,Vector=Values[De]" value="0.40000000000000002" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Moore_2004,Vector=Values[gamma_E]" value="0.079000000000000001" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Moore_2004,Vector=Values[An]" value="0.39000000000000001" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Moore_2004,Vector=Values[Ae]" value="0.65000000000000002" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Moore_2004,Vector=Values[Dn]" value="0.34999999999999998" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Moore_2004,Vector=Values[Rc]" value="0.010999999999999999" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Moore_2004,Vector=Values[Cmax]" value="160000" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Moore_2004,Vector=Values[Dc]" value="0.012" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Moore_2004,Vector=Values[gamma_C]" value="0.058000000000000003" type="ModelValue" simulationType="fixed"/>
        </ModelParameterGroup>
        <ModelParameterGroup cn="String=Kinetic Parameters" type="Group">
          <ModelParameterGroup cn="CN=Root,Model=Moore_2004,Vector=Reactions[Naive_Tcells_production]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=Moore_2004,Vector=Reactions[Naive_Tcells_production],ParameterGroup=Parameters,Parameter=v" value="0.28999999999999998" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
          ...
          <ModelParameterGroup cn="CN=Root,Model=Moore_2004,Vector=Reactions[Naive_Tcells_degradation]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=Moore_2004,Vector=Reactions[Naive_Tcells_degradation],ParameterGroup=Parameters,Parameter=Dn" value="0.34999999999999998" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=Moore_2004,Vector=Values[Dn],Reference=InitialValue>
              </InitialExpression>
            </ModelParameter>
            <ModelParameter cn="CN=Root,Model=Moore_2004,Vector=Reactions[Naive_Tcells_degradation],ParameterGroup=Parameters,Parameter=Kn" value="0.066000000000000003" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=Moore_2004,Vector=Values[Kn],Reference=InitialValue>
              </InitialExpression>
            </ModelParameter>
            <ModelParameter cn="CN=Root,Model=Moore_2004,Vector=Reactions[Naive_Tcells_degradation],ParameterGroup=Parameters,Parameter=n" value="140" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
          ...
          <ModelParameterGroup cn="CN=Root,Model=Moore_2004,Vector=Reactions[eff_Tcells_production]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=Moore_2004,Vector=Reactions[eff_Tcells_production],ParameterGroup=Parameters,Parameter=An" value="0.39000000000000001" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=Moore_2004,Vector=Values[An],Reference=InitialValue>
              </InitialExpression>
            </ModelParameter>
            <ModelParameter cn="CN=Root,Model=Moore_2004,Vector=Reactions[eff_Tcells_production],ParameterGroup=Parameters,Parameter=Kn" value="0.066000000000000003" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=Moore_2004,Vector=Values[Kn],Reference=InitialValue>
              </InitialExpression>
            </ModelParameter>
            <ModelParameter cn="CN=Root,Model=Moore_2004,Vector=Reactions[eff_Tcells_production],ParameterGroup=Parameters,Parameter=n" value="140" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=Moore_2004,Vector=Values[n],Reference=InitialValue>
              </InitialExpression>
            </ModelParameter>
            <ModelParameter cn="CN=Root,Model=Moore_2004,Vector=Reactions[eff_Tcells_production],ParameterGroup=Parameters,Parameter=Ae" value="0.65000000000000002" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
          ...
          <ModelParameterGroup cn="CN=Root,Model=Moore_2004,Vector=Reactions[eff_Tcells_degradation]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=Moore_2004,Vector=Reactions[eff_Tcells_degradation],ParameterGroup=Parameters,Parameter=De" value="0.40000000000000002" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=Moore_2004,Vector=Values[De],Reference=InitialValue>
              </InitialExpression>
            </ModelParameter>
            <ModelParameter cn="CN=Root,Model=Moore_2004,Vector=Reactions[eff_Tcells_degradation],ParameterGroup=Parameters,Parameter=gammaE" value="0.079000000000000001" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
          ...
          <ModelParameterGroup cn="CN=Root,Model=Moore_2004,Vector=Reactions[Tumor_growth]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=Moore_2004,Vector=Reactions[Tumor_growth],ParameterGroup=Parameters,Parameter=Rc" value="0.010999999999999999" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=Moore_2004,Vector=Values[Rc],Reference=InitialValue>
              </InitialExpression>
            </ModelParameter>
            <ModelParameter cn="CN=Root,Model=Moore_2004,Vector=Reactions[Tumor_growth],ParameterGroup=Parameters,Parameter=Cmax" value="160000" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
          ...
          <ModelParameterGroup cn="CN=Root,Model=Moore_2004,Vector=Reactions[Tumor_killing]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=Moore_2004,Vector=Reactions[Tumor_killing],ParameterGroup=Parameters,Parameter=Dc" value="0.012" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=Moore_2004,Vector=Values[Dc],Reference=InitialValue>
              </InitialExpression>
            </ModelParameter>
            <ModelParameter cn="CN=Root,Model=Moore_2004,Vector=Reactions[Tumor_killing],ParameterGroup=Parameters,Parameter=gammaC" value="0.058000000000000003" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
    ...
    <InitialState type="initialState">
      0 9.0934326940700007e+23 1.2044281714000001e+22 6.0221408569999997e+24 1 0.28999999999999998 140 0.066000000000000003 0.40000000000000002 0.079000000000000001 0.39000000000000001 0.65000000000000002 0.34999999999999998 0.010999999999999999 160000 0.012 0.058000000000000003 
    </InitialState>
  </Model>
  <ListOfTasks>
