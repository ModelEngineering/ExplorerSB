...
<!-- generated with COPASI 4.24 (Build 197) (http://www.copasi.org) at 2018-10-16 13:15:13 UTC -->
...
<rdf:RDF
  ...
  <rdf:Description rdf:about="#Model_0">
    ...
    <bqbiol:hasTaxon rdf:resource="urn:miriam:taxonomy:336207"/>
  ...
  <rdf:Description rdf:about="#Reaction_0">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5798" name="alpha" value="2.22"/>
          <Constant key="Parameter_5800" name="k_p" value="4.85"/>
        </ListOfConstants>
  ...
  <rdf:Description rdf:about="#Reaction_2">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5795" name="gamma" value="0.29"/>
        </ListOfConstants>
...
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Reaction_5">
    ...
    <ListOfModelParameterSets activeSet="ModelParameterSet_0">
      <ModelParameterSet key="ModelParameterSet_0" name="Initial State">
        ...
        <ModelParameterGroup cn="String=Initial Global Quantities" type="Group">
          <ModelParameter cn="CN=Root,Model=New Model,Vector=Values[alpha]" value="2.2200000000000002" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=New Model,Vector=Values[k_p]" value="4.8499999999999996" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=New Model,Vector=Values[beta]" value="1" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=New Model,Vector=Values[gamma']" value="0.28999999999999998" type="ModelValue" simulationType="fixed"/>
        ...
        <ModelParameterGroup cn="String=Kinetic Parameters" type="Group">
          <ModelParameterGroup cn="CN=Root,Model=New Model,Vector=Reactions[Infection of Virus]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=New Model,Vector=Reactions[Infection of Virus],ParameterGroup=Parameters,Parameter=alpha" value="2.2200000000000002" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=New Model,Vector=Values[alpha],Reference=InitialValue>
              </InitialExpression>
            </ModelParameter>
            <ModelParameter cn="CN=Root,Model=New Model,Vector=Reactions[Infection of Virus],ParameterGroup=Parameters,Parameter=k_p" value="4.8499999999999996" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
          ...
          <ModelParameterGroup cn="CN=Root,Model=New Model,Vector=Reactions[Activation of the defense system]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=New Model,Vector=Reactions[Activation of the defense system],ParameterGroup=Parameters,Parameter=gamma" value="0.28999999999999998" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
    ...
    <InitialState type="initialState">
      0 6.0221408570000005e+18 0 0 6.0221408570000005e+18 0.23840584404423515 1 2.2200000000000002 4.8499999999999996 1 0.28999999999999998 0.01 0 1 1 1.8200000000000001 
    </InitialState>
  </Model>
  <ListOfTasks>
