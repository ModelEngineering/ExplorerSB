...
prefilenames = ['simFig9']
ofilenames = ['fig9A', 'fig9B','fig9C']
# Figure name
prefig = 'Fig9'
...
x_name = ['time']
y_name = ['phosphorylation','stress','Cai']
y_labels = ['(A) Phosphorylation (%)','(B) Stress (%)', '(C) [Ca]$_i$ (nM)']
